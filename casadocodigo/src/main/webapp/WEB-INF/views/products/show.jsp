...
<head>
	...
	<link href="../css/cssbase-min.css" rel="stylesheet" type="text/css" media="all" />
	<link href='http://fonts.googleapis.com/css?family=Droid+Sans:400,700' rel='stylesheet'/>
	<link href="../css/fonts.css" rel="stylesheet" type="text/css" media="all" />
	<link href="../css/fontello-ie7.css" rel="stylesheet" type="text/css" media="all" />
	<link href="../css/fontello-embedded.css" rel="stylesheet" type="text/css" media="all" />
	<link href="../css/fontello.css" rel="stylesheet" type="text/css" media="all" />
	<link href="../css/style.css" rel="stylesheet" type="text/css" media="all" />
	<link href="../css/layout-colors.css" rel="stylesheet" type="text/css" media="all" />
	<link href="../css/responsive-style.css" rel="stylesheet" type="text/css" media="all" />
	<link href="../css/guia-do-programador-style.css" rel="stylesheet" type="text/css"  media="all"  />
    <link href="../css/produtos.css" rel="stylesheet" type="text/css"  media="all"  />
